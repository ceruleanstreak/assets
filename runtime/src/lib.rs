...
/// Configure the planet-assets in pallets/planet_assets.
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Sudo: pallet_sudo,
		// Include the custom logic from the planet-assets in the runtime.
		PlanetAssets: planet_assets,
	}
);
